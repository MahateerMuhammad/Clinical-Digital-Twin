#!/usr/bin/env python3
"""
scripts/evaluation/run_explainability_audit.py
───────────────────────────
...
Usage
─────
    python scripts/evaluation/run_explainability_audit.py                 # all phases
    python scripts/evaluation/run_explainability_audit.py --phases 1,3    # a subset
    python scripts/evaluation/run_explainability_audit.py --sample 3000   # smaller SHAP sample
"""
...
> [!NOTE]
> Generated by `scripts/evaluation/run_explainability_audit.py` from the models in `models/`. SHAP
