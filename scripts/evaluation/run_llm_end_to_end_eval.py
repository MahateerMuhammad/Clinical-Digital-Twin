#!/usr/bin/env python3
"""
scripts/evaluation/run_llm_end_to_end_eval.py
──────────────────────────
...
Usage
─────
    python scripts/evaluation/run_llm_end_to_end_eval.py
    python scripts/evaluation/run_llm_end_to_end_eval.py --cases 40 --no-llm
"""
