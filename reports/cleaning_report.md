...
Generated: 2026-07-19T10:18:00Z

> [!NOTE]
> **Duplicate Counting Conventions**:
> - **Summary Table (`dup_before` / `dup_after`)**: Uses `keep='first'` to count ONLY extra redundant rows beyond the initial occurrence ($N - G$).
> - **Documented Actions Table (`flag_duplicates`)**: Uses `keep=False` to count ALL rows involved in duplicate clusters ($N$ total rows across all duplicate groups).
...
| prescriptions    |          25 | /Users/apple/Desktop/Clinical Digital Twin/data/interim/prescriptions_clean.parquet    |      20292611 |     20292611 |      2513586 |     2513586 |
...
| radiology_detail |           1 | /Users/apple/Desktop/Clinical Digital Twin/data/interim/radiology_detail_clean.parquet |       6046121 |      6046121 |       161550 |      161550 |
...
| prescriptions    | flag_duplicates         |                                      |      4997485 | duplicates retained with _is_duplicate flag; not removed                             |                |
...
| radiology_detail | flag_duplicates         |                                      |       250366 | duplicates retained with _is_duplicate flag; not removed                             |                |